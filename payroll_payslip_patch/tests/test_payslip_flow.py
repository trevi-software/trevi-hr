...
# This file is copied verbatim from OCA/payroll/payroll. All updates to
# that file should be done to this file also. We use this test as a check
# that our patch didn't break any functionality in the original module.

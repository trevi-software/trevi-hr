    ...
    def _track_subtype(self, init_values):
        ...
        if "state" in init_values:
            if self.state == "confirm":
                return self.env["hr_employee_state.mt_alert_state_confirm"]
            elif self.state == "done":
                return self.env["hr_employee_state.mt_alert_state_done"]
            elif self.state == "cancel":
                return self.env["hr_employee_state.mt_alert_state_cancel"]

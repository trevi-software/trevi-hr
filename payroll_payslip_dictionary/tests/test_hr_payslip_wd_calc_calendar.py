...
class TestHrPayslip(common.TestHrPayslip):
    def setUp(self):
        ...
        self.env["ir.config_parameter"].set_param(
            "payroll_payslip_dictionary.working_days_calculation", "calendar"
        )
    ...
    def tearDown(self):
        ...
        self.env["ir.config_parameter"].set_param(
            "payroll_payslip_dictionary.working_days_calculation", "30"
        )
        self.env["ir.config_parameter"].set_param(
            "payroll_payslip_dictionary.working_days_calculation", "calendar"
        )
    ...
    def test_contract_ppf_days_less_than_payroll_days31(self):
        ...
        c1_start = date(2022, 1, 30)
        c1_end = date(2022, 3, 10)
        self.create_contract(c1_start, c1_end, self.alice_emp, 5000.0)

        # I create a second contract for "Richard" of another 10 days
        c2_start = date(2022, 3, 11)
        c2_end = date(2022, 3, 20)
        self.create_contract(
            c2_start, c2_end, self.alice_emp, 15000.0, "2nd Contract for Richard"
        )
        ...
        self.assertEqual(
            sum_amounts,
            6452.00,
            "The calculated amount is 0.3226 first wage + 0.3226 of second wage",
        )
    ...
    def test_contract_ppf_february(self):
        ...
        self.assertEqual(
            sum_amounts,
            7321.50,
            "The calculated amount is 0.5357 x first wage + 0.4643 * second wage",
        )
